  ...
  return (
    <main className="bg-white text-black min-h-screen font-sans">
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-10 space-y-14 max-w-5xl">
        ...
        {/* Bail & Anticipatory Bail Assistance */}
        <section>
          ...
          <ul className="list-disc ml-6 mb-4 text-gray-700 space-y-1">
            ...
            <li><em>Anticipatory Bail</em> – sought in anticipation of arrest.</li>
            <li><em>Interim Bail</em> – temporary bail pending final decision.</li>
          ...
          <ul className="list-disc ml-6 mb-4 text-gray-700 space-y-1">
            <li>Engage skilled <em>legal counsel</em> experienced in judicial trends.</li>
            <li>File a well-drafted bail application highlighting cooperation and facts.</li>
            <li>Provide ID, residence proof, employment records, FIR copy, and sureties.</li>
            <li>Comply with court conditions like reporting, non-interference, or surrender of passport.</li>
          </ul>
...
. <strong>JP Law Suvidha</strong> <em>legal consultation</em> ensures such rights are protected and cases are followed through legally.
        ...
        {/* Responding to a Police Complaint or FIR */}
        <section>
...
. <span className="font-bold text-black">JP Law Suvidha</span> <em>connects</em> clients with criminal defense lawyers for every step.
        ...
        <footer className="border-t border-gray-300 pt-8 mt-12 text-center text-gray-600 text-base italic">
          <p className="text-base sm:text-lg leading-relaxed">
            <span className="font-bold text-black italic">JP Law Suvidha</span> is your <mark>trusted platform</mark> for expert criminal law defense, legal consultation, bail application support, and <mark>digital solutions</mark> for complex criminal cases across India.
          </p>
        </footer>
      </section>
    </main>
